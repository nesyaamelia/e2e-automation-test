...
WebUI.click(findTestObject('Object Repository/Register/div_hai, kasirAjakasirAja sebuah sistem POS_69dfd1'))

WebUI.setText(findTestObject('Object Repository/Register/input_nama toko_name'), nama_toko)

WebUI.setText(findTestObject('Object Repository/Register/input_email_email'), 'tokosunday@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/input_password_password'), 'QGq1NTSxdahTVhbwtiX8yQ==')
